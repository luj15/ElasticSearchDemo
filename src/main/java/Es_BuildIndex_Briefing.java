 ...
 */
public class Es_BuildIndex_Briefing {

    static final String index_name = "sku_platform_wind_briefing";
    static final String type_name = "platform_wind_briefing";
...
//                .setTTL(8000)//这样就等于单独设定了该条记录的失效时间,单位是毫秒,必须在mapping中打开_ttl的设置开关
     ...
     */
    protected static void buildBulkIndex(List<Briefing> list) throws IOException {
...
//        }
        ...
        List<Briefing> randomBriefs = Briefing.getRandomBriefs(5000);
        buildBulkIndex(randomBriefs);
