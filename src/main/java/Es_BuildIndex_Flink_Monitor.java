 ...
 */
public class Es_BuildIndex_Flink_Monitor {

    static final String index_name = "flink_log_monitor_index";
    static final String type_name = "flink_log_monitor_type";
    static final String aliases = "flink_log";
