 ...
 * @author 小和尚
 * @version 1.0.0
 * @ClassName ElasticSearch.User
 * @Description TODO
 * @createTime 2019年11月25日 18:56:00
 */
public class User {
    ...
    public User(String name, String home, String now_home, double height, int age, String birthday, boolean isRealMen, Location location) {
        this.name = name;
        this.home = home;
     ...
     * @return User
     */
    public static User getOneRandomUser() throws ParseException {
        Random random = new Random();
        Date date = new Date(System.currentTimeMillis() - (long) (Math.random() * 100000));
        ...
        return new User("葫芦" + random.nextInt(10000) + "娃", home, now_home, random.nextInt(10000),
                random.nextInt(10000),format, random.nextBoolean(), location);
    }
